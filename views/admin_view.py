...
class AdminWindow(QWidget):
    ...
    def init_ui(self):
        ...
        menu_items = ["Panel Principal", "Usuarios", "Hospitales", "Auditoría", "Doctores", 
        ...
        self.stack.addWidget(UsersModule())
        self.stack.addWidget(HospitalsModule())
        self.stack.addWidget(AuditModule())
        self.stack.addWidget(DoctorsModule())
        self.stack.addWidget(PatientsModule())
        self.stack.addWidget(AdministrativeModule())
