...
class DoctorWindow(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Panel de doctor")
    ...
    def init_ui(self):
        ...
        menu_items = ["Panel Principal", "Hospitales","Consultorios", "Laboratorios", 
                     "Citas", "Farmacia", "receta digital", "Cerrar Sesión"]
        ...
        self.stack.addWidget(PrescriptionModule())
